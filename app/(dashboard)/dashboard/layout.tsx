...
import MobleSidebar from "@/components/MobleSidebar";
...
export default async function layout({
  ...
  return (
    <div className="w-full flex h-screen">
      ...
      />
      <div className="md:flex hidden h-full w-full max-w-[17rem] lg:max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
